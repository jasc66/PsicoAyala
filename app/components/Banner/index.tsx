                    ...
                    <div className='grid grid-cols-1 lg:grid-cols-12 my-16'>
                        ...
                        <div className='col-span-7'>
                            <h1 className="text-4xl lg:text-7xl font-bold mb-5 text-white md:4px md:text-start text-center">
                                Especialistas en Psicología <br /> Terapía
                            </h1>
                            ...
                            <div className='flex align-middle justify-center md:justify-start'>
                                <button className='text-xl font-semibold text-white py-4 px-6 lg:px-12 navbutton mr-6'>Inicio</button>
                        ...
                        <div className='col-span-5 lg:-m-48'>
                            ...
                            <Image src="/images/Banner/banner-fre.png" alt="nothing" width={980} height={760} />
